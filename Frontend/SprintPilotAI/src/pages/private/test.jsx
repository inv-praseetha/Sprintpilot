          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-slate-100 dark:border-slate-800 text-slate-400 text-xs font-semibold text-left">
                ...
                <th className="py-4 px-4 font-semibold text-slate-400">Total Task</th>
                <th className="py-4 px-4 font-semibold text-slate-400">Completed</th>
                <th className="py-4 px-4 font-semibold text-slate-400">On Progress</th>
                <th className="py-4 px-4 font-semibold text-slate-400">Overdue</th>
                <th className="py-4 px-4 font-semibold text-slate-400">Status</th>
                ...
                >
                  ...
                  <td className="py-4 px-4 text-left">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-slate-600 dark:text-slate-400">{member.role}</span>
                    </div>
                  </td>

                  {/* Total Tasks */}
                  <td className="py-4 px-4 text-slate-700 dark:text-slate-300 text-left">{member.totalTasks} Task</td>

                  {/* Completed */}
                  <td className="py-4 px-4 text-slate-700 dark:text-slate-300 text-left">{member.completed} Task</td>

                  {/* On Progress */}
                  <td className="py-4 px-4 text-slate-700 dark:text-slate-300 text-left">{member.onProgress} Task</td>

                  {/* Overdue */}
                  <td className="py-4 px-4 text-slate-700 dark:text-slate-300 text-left">{member.overdue} Task</td>

                  {/* Status Badge */}
                  <td className="py-4 px-4 text-left">
                    {member.statusType === 'available' ? (
